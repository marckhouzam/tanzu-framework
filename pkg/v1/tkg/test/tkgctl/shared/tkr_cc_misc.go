...
func VerifyPackagesAreAvailable(expectedPackages []v1.LocalObjectReference, packages []*kapppkgv1alpha1.Package) error {
...
func getPackagesNames(packages []*kapppkgv1alpha1.Package) sets.StringSet {
